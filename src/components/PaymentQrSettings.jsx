...
export default function PaymentQrSettings({setMsg}) {
  const [qr,setQr]=useState(localStorage.getItem("picklecity_payment_qr")||"/qr-vcb-final.png");
  function onFile(e){
  ...
  function reset(){localStorage.removeItem("picklecity_payment_qr");setQr("/qr-vcb-final.png");setMsg?.("Đã khôi phục QR mặc định.");}
